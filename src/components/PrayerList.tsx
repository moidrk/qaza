      ...
      {requiredPrayers.map((prayer) => {
        ...
        return (
          <motion.div
            ...
            key={prayer}
            className={`
              p-4 rounded-2xl flex flex-col sm:flex-row sm:items-center justify-between transition-all border
          ...
          >
            ...
            <div className="flex items-center gap-2 w-full mt-3 sm:mt-0 sm:w-auto">
              {isExcused ? (
                <div className="w-12 h-12 sm:w-11 sm:h-11 rounded-full bg-sky-500/10 border-2 border-sky-500/30 text-sky-600 dark:text-sky-400 flex items-center justify-center" aria-hidden="true">
                ...
                <>
                  <button
                    ...
                    className={`h-12 sm:h-11 px-3 min-w-[44px] flex-1 sm:flex-none rounded-full border-2 flex items-center justify-center gap-1.5 overflow-hidden transition-all active:scale-90
                  ...
                  >
                    ...
                    <span className="text-xs font-semibold sm:block">{isMissed ? 'Missed' : 'Miss'}</span>
                  </button>
                  <button
                    type="button"
                    disabled={isFuture || isExcused}
                    ...
                    className={`h-12 sm:h-11 px-4 min-w-[44px] flex-[2] sm:flex-none rounded-full border-2 flex items-center justify-center gap-1.5 overflow-hidden transition-all active:scale-90
