        ...
        return (
          ...
          >
            <div className="w-full flex items-center justify-between sm:justify-start">
              ...
              {isExcused && (
                <div className="sm:hidden w-11 h-11 rounded-full bg-sky-500/10 border-2 border-sky-500/30 text-sky-600 dark:text-sky-400 flex items-center justify-center" aria-hidden="true">
            ...
            <div className="w-full sm:w-auto flex items-center gap-2">
              {isExcused ? (
                <div className="hidden sm:flex w-11 h-11 rounded-full bg-sky-500/10 border-2 border-sky-500/30 text-sky-600 dark:text-sky-400 items-center justify-center" aria-hidden="true">
                  <span className="text-[10px] font-bold leading-none">EX</span>
                </div>
              ) : (
                <>
                  ...
                  <button
                    ...
                    className={`flex-1 sm:flex-none h-11 px-4 min-w-[44px] rounded-full border-2 flex items-center justify-center gap-1.5 overflow-hidden transition-all active:scale-90
