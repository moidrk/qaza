      ...
      {requiredPrayers.map((prayer) => {
        ...
        return (
          <motion.div
            ...
            key={prayer}
            className={`
              p-4 rounded-2xl flex flex-col sm:flex-row sm:items-center justify-between gap-3 sm:gap-4 transition-all border
              ...
              {isExcused ? (
                ...
                <>
                  <button
                    ...
                    className={`h-12 w-full sm:w-auto px-3 min-w-[44px] flex-1 sm:flex-none rounded-full border-2 flex items-center justify-center gap-1.5 overflow-hidden transition-all active:scale-90
                  ...
                  >
                    ...
                    <span className="text-sm font-semibold">{isMissed ? "Missed" : "Miss"}</span>
                  </button>
                  <button
                    type="button"
                    disabled={isFuture || isExcused}
                    ...
                    className={`h-12 w-full sm:w-auto px-4 min-w-[44px] flex-[2] sm:flex-none rounded-full border-2 flex items-center justify-center gap-1.5 overflow-hidden transition-all active:scale-90
                  ...
                  >
                    ...
                    <span className="text-sm font-semibold">{isDone ? "Prayed" : "Pray"}</span>
                  </button>
                </>
              )}
            </div>
