              ...
              {isExcused ? (
                ...
                <>
                  <button
                    ...
                    className={`h-11 min-w-[44px] rounded-full border-2 flex-1 sm:flex-none flex items-center justify-center gap-1.5 overflow-hidden transition-all active:scale-90
