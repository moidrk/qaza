              ...
              {isExcused ? (
                ...
                <>
                  <button
                    ...
                    className={`h-11 px-3 w-full sm:w-auto min-w-[44px] flex-none rounded-full border-2 flex items-center justify-center gap-1.5 overflow-hidden transition-all active:scale-90
                  ...
                  <button
                    ...
                    className={`h-11 px-4 w-full sm:w-auto min-w-[44px] flex-none rounded-full border-2 flex items-center justify-center gap-1.5 overflow-hidden transition-all active:scale-90
