      ...
      {requiredPrayers.map((prayer) => {
        ...
        return (
          ...
          >
            ...
            <div className="flex flex-col-reverse sm:flex-row items-stretch sm:items-center gap-2 w-full sm:w-auto mt-3 sm:mt-0">
              {isExcused ? (
                ...
                <>
                  <button
                    ...
                    className={`h-11 min-w-[44px] rounded-full border-2 flex items-center justify-center gap-1.5 overflow-hidden transition-all active:scale-90
                      ${isMissed ? 'w-full sm:w-auto px-4 bg-amber-500/10 border-amber-500/40 text-amber-600 dark:text-amber-500' : 'w-full sm:w-auto px-4 border-border hover:border-amber-500/40 hover:bg-amber-500/5 text-muted-foreground hover:text-amber-600'}
