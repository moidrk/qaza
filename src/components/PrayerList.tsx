      ...
      {requiredPrayers.map((prayer) => {
        ...
        return (
          <motion.div
            ...
            key={prayer}
            className={`
              p-4 rounded-2xl flex flex-col sm:flex-row flex-wrap items-stretch sm:items-center justify-between gap-3 sm:gap-4 transition-all border
          ...
          >
            ...
            <div className="flex flex-col-reverse sm:flex-row items-stretch sm:items-center gap-2 w-full sm:w-auto mt-2 sm:mt-0">
              {isExcused ? (
                <div className="w-full sm:w-11 h-11 rounded-full sm:rounded-full bg-sky-500/10 border-2 border-sky-500/30 text-sky-600 dark:text-sky-400 flex items-center justify-center" aria-hidden="true">
                ...
                <>
                  ...
                  <button
                    ...
                    className={`h-11 min-w-[44px] rounded-full border-2 flex items-center justify-center gap-1.5 overflow-hidden transition-all active:scale-90
                      ${isDone ? 'w-full sm:w-auto px-4 bg-primary border-primary text-primary-foreground' : 'w-full sm:w-auto px-4 border-border hover:border-primary/40 hover:bg-primary/5 text-muted-foreground hover:text-primary'}
                      ${isFuture || isExcused ? 'cursor-not-allowed opacity-50' : 'cursor-pointer'}
                    `}
                  >
