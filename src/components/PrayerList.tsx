                ...
                <>
                  <button
                    ...
                    className={`h-11 min-w-[44px] rounded-full border-2 flex items-center justify-center gap-1.5 overflow-hidden transition-all active:scale-90
                      ${isMissed ? 'w-full px-4 sm:w-auto bg-amber-500/10 border-amber-500/40 text-amber-600 dark:text-amber-500' : 'w-full sm:w-auto sm:px-3 border-border hover:border-amber-500/40 hover:bg-amber-500/5 text-muted-foreground hover:text-amber-600'}
                  ...
                  <button
                    ...
                    className={`h-11 min-w-[44px] rounded-full border-2 flex items-center justify-center gap-1.5 overflow-hidden transition-all active:scale-90
                      ${isDone ? 'w-full px-4 sm:w-auto bg-primary border-primary text-primary-foreground' : 'w-full sm:w-auto sm:px-4 border-border hover:border-primary/40 hover:bg-primary/5 text-muted-foreground hover:text-primary'}
                      ${isFuture || isExcused ? 'cursor-not-allowed opacity-50' : 'cursor-pointer'}
                    `}
                  >
