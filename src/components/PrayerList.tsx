        ...
        return (
          ...
          >
            ...
            <div className="flex items-center gap-2 w-full sm:w-auto">
              {isExcused ? (
                <div className="w-11 h-11 rounded-full bg-sky-500/10 border-2 border-sky-500/30 text-sky-600 dark:text-sky-400 flex items-center justify-center flex-1 sm:flex-none" aria-hidden="true">
