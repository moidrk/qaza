              ...
              >
                <div className="flex items-center justify-between w-full">
                  <div className="flex items-center gap-4">
                    <h3 className={`text-lg font-bold w-20 text-left ${isCaughtUp ? 'text-muted-foreground' : ''}`}>{prayer}</h3>
                    {isCaughtUp ? (
                      <div className="flex items-center justify-center gap-1 text-emerald-600/80 bg-emerald-50/50 dark:bg-emerald-950/20 px-2 py-0.5 rounded-full">
                  ...
                  <ChevronRight className="text-muted-foreground/50 w-5 h-5" />
                </div>
              </Card>
            )
          })}
